...
Исправлено:
  ...
  - Плагин `GetIP`. По просьбе Администраторов в настройки добавлена опция "Указывать Ник пользователя, которого вы проверяете, в Админ чате", которую можно снять, после чего вместо Ника будет выводится слово "Возможно: ...".

...
### F.A.Q.
  ...
  - **Для этого вам потребуется биндер "AutoHotkey". Скачать его можно [отсюда](ahkscript.org/download/ahk-install.exe), после чего его нужно установить (ANSI-32bit), а далее двойным кликом запустить AdminHelper.ahk из корня папки с данным скриптом.**
